...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['3 sync channels', 'Event-diff strategy', 'LWW conflict resolution', 'Community support'] },
  { name: 'Pro', price: '$49/mo', features: ['100 sync channels', 'All strategies (event-diff, snapshot, hybrid)', 'Custom conflict resolution', 'Selective field sync', '50,000 API calls/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited channels', 'Unlimited peers', 'Multi-region P2P', 'Custom merge logic', 'SLA 99.99%', 'Dedicated support'] },
];
